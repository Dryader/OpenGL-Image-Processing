...
void Shader::LoadAttributes()
{
    ...
    m_uniformYScale = glGetUniformLocation(m_programID, "yScale");
    m_uniformUScale = glGetUniformLocation(m_programID, "uScale");
    m_uniformVScale = glGetUniformLocation(m_programID, "vScale");
    m_uniformInvertColors = glGetUniformLocation(m_programID, "invertColors");
}
